...
namespace SpatialIndex
{
    namespace LERTree
    {
        class LERTree : public ISpatialIndex
        {
        public:
            LERTree(IStorageManager&, Tools::PropertySet&);
        ...
        private:
            ...
            //void insertData_impl(uint32_t dataLength, uint8_t* pData, Region& mbc, id_type id);
            //void insertData_impl(uint32_t dataLength, uint8_t* pData, Region& mbc, id_type id, uint32_t level, uint8_t* overflowTable);
            ...
            Tools::PointerPool<MBCs> m_MBCsPool;
            Tools::PointerPool<Node> m_indexPool;
            Tools::PointerPool<Node> m_L1indexPool;
            ...
            friend std::ostream& operator<<(std::ostream& os, const LERTree& t);
        };//LERTree
    }
}
