...
namespace SpatialIndex
{
    namespace PAAR2Tree
    {
        class PAAR2Tree : public ISpatialIndex
        {
        public:
            PAAR2Tree(IStorageManager&, Tools::PropertySet&);
        ...
        private:
            ...
            //void insertData_impl(uint32_t dataLength, uint8_t* pData, MBBCk& mbbc, id_type id);
            //void insertData_impl(uint32_t dataLength, uint8_t* pData, MBBCk& mbbc, id_type id, uint32_t level, uint8_t* overflowTable);
            ...
            Tools::PointerPool<MBBCk> m_MBBCkPool;
            ...
            friend std::ostream& operator<<(std::ostream& os, const PAAR2Tree& t);
        };//PAAR2Tree
    }
}
